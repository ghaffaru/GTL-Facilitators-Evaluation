    ...
    <div class="col-md-6">
        ...
        <form action="/facilitatorsurvey" method="post">
          ...
          <div class="form-group">
              ...
              <select name="objectives" class="form-control" required>
          ...
          <div class="form-group">
              ...
              <textarea name="explain" class="form-control" required></textarea>
          </div>
          ...
          <div class="form-group">
              ...
              <textarea name="list" class="form-control" required></textarea>
          </div>
          ...
          <div class="form-group">
              ...
              <textarea name="materials" class="form-control" required></textarea>
          </div>
          ...
          <div class="form-group">
              ...
              <textarea name="prepare" class="form-control" required></textarea>
          </div>
          ...
          <div class="form-group">
              ...
              <textarea name="modules" class="form-control" required></textarea>
          </div>
